...
function CustomizationForm({
  ...
  return (
    <div className="space-y-6">
      {/* Only show the banner for errors; success is shown inline next to the button */}
      ...
      <div className="rounded-2xl border border-outline-variant/30 bg-surface-container-lowest p-5 space-y-5">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <label className={`${labelCls} md:col-span-2`}>
            ...
            <input className={inputCls} value={form.tagline} onChange={set("tagline")} maxLength={120} placeholder="Short brand tagline farmers will remember" />
          </label>
          <label className={`${labelCls} md:col-span-2`}>
