...
class StockSearchService {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        for (final q in quotes) {
             ...
             final isIndian = (exch == 'NSI' || exch == 'BSE' || symbol.endsWith('.NS') || symbol.endsWith('.BO'));
             ...
             results.add(StockTickerModel(
                ...
                price: 0.0, // Search API often doesn't give RT price. We fetch later or UI shows "..."
                sector: sector,
             ));
        }
        return results;
  ...
  Future<double?> fetchPrice(String symbol) async {
      try {
          ...
          print("Yahoo Price Error for $symbol: $e");
      }
      return null;
  }
