...
class SubscriptionNotifier {
  ...
  Future<void> _scheduleForSubscription(SubscriptionItem sub, DateTime now) async {
    ...
    final trigger = DateTime(alertTime.year, alertTime.month, alertTime.day, 9, 0);
    ...
    await NotificationService().scheduleAt(
      ...
      body: 'Your subscription of ₹${sub.amount.toInt()} is due on ${_formatDate(due)}. Tap to view.',
      when: trigger,
