...
class SubsBillsAddChoiceSheet extends StatelessWidget {
  ...
  final List<SubsBillsAddChoice>? options;
  ...
  List<SubsBillsAddChoice> get _defaultRecurringChoices => const [
        SubsBillsAddChoice(
  ...
  Widget build(BuildContext context) {
    ...
    Widget card(SubsBillsAddChoice c) {
      return InkWell(
