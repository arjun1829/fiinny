// lib/screens/subs_bills/add_flow/add_custom_reminder_sheet.dart
...
class SubsBillsAddCustomReminderSheet extends StatefulWidget {
  final String userPhone;
  final RecurringScope scope;
  final List<String> participantUserIds;
  final bool mirrorToFriend;
  final String? friendId;
  const SubsBillsAddCustomReminderSheet({
    Key? key,
  ...
  @override
  State<SubsBillsAddCustomReminderSheet> createState() => _SubsBillsAddCustomReminderSheetState();
}

class _SubsBillsAddCustomReminderSheetState extends State<SubsBillsAddCustomReminderSheet> {
