// lib/screens/subs_bills/add_flow/add_recurring_sheet.dart
import 'package:flutter/material.dart';
import 'package:intl/intl.dart';

class SubsBillsAddRecurringDraft {
  final String title;
...
class SubsBillsAddRecurringSheet extends StatefulWidget {
  final String userPhone;
  final String friendId;

  const SubsBillsAddRecurringSheet({
    Key? key,
  ...
  @override
  State<SubsBillsAddRecurringSheet> createState() => _SubsBillsAddRecurringSheetState();
}

class _SubsBillsAddRecurringSheetState extends State<SubsBillsAddRecurringSheet> {
  ...
  void _submit() {
    ...
    final draft = SubsBillsAddRecurringDraft(
