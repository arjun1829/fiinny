// lib/screens/subs_bills/add_flow/add_subscription_screen.dart
import 'dart:io';
...
class SubsBillsAddSubscriptionScreen extends StatefulWidget {
  final String userPhone;
  final RecurringScope scope;
  final List<String> participantUserIds;
  final bool mirrorToFriend;
  const SubsBillsAddSubscriptionScreen({
    Key? key,
  ...
  @override
  State<SubsBillsAddSubscriptionScreen> createState() => _SubsBillsAddSubscriptionScreenState();
}
...
class _SubsBillsAddSubscriptionScreenState extends State<SubsBillsAddSubscriptionScreen> {
