...
// For tokens if needed, though we use custom brand color here

class AddAssetScreen extends StatefulWidget {
  final String userId;
  const AddAssetScreen({required this.userId, super.key});
...
class _AddAssetScreenState extends State<AddAssetScreen>
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      final model = AssetModel(
        ...
        assetType: _type,
        subType: _subTypeSelected == _other
            ? _subTypeCtrl.text.trim()
            : _subTypeSelected,
        institution:
            _instSelected == _other ? _instCtrl.text.trim() : _instSelected,
        quantity: _asDouble(_qtyCtrl) > 0 ? _asDouble(_qtyCtrl) : null,
        avgBuyPrice: _asDouble(_avgCtrl) > 0 ? _asDouble(_avgCtrl) : null,
        purchaseValue: _asDouble(_purchaseValueCtrl) > 0
            ? _asDouble(_purchaseValueCtrl)
            : null,
        ...
        logoHint: _logoHintCtrl.text.trim().isEmpty
            ? null
            : _logoHintCtrl.text.trim(),
        ...
        GestureDetector(
          onTap: () {
            ...
            ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                content: Text("Coming Soon: Import from CAS PDF!")));
          },
          child: Container(
            ...
            child: Row(
              children: [
                ...
                const Expanded(
                  ...
                  children: [
                    Text("Auto-Import from Email/CAS",
                        style: TextStyle(
                            fontWeight: FontWeight.w700,
                            fontSize: 13,
                            color: Colors.black87)),
                    Text("The fastest way to track portfolio.",
  ...
  Widget _buildEmptySearchState() {
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            const Text("Start typing to search stocks...",
                style: TextStyle(color: Colors.grey)),
            const SizedBox(height: 24),
            Wrap(
                spacing: 8,
                children: ["HDFC", "Reliance", "Gold", "Nifty"]
                    .map((s) => ActionChip(
                          label: Text(s),
                          onPressed: () {
                            _searchCtrl.text = s;
    ...
    return const Center(
        child: Text("No results found. Try adding manually.",
            style: TextStyle(color: Colors.grey)));
  }
    ...
    return Form(
        ...
        child: ListView(
          padding: EdgeInsets.fromLTRB(
              16, 18, 16, context.adsBottomPadding(extra: 28)),
          children: [
            _heroTip(
                _titleCtrl.text.isNotEmpty
                    ? "Completing details for ${_titleCtrl.text}"
                    : "Add Custom Asset",
            ...
            _DropdownWithOther(
              ...
              validator: (val) => (_titleCtrl.text.trim().isEmpty)
                  ? "Enter a valid title"
                  : null,
            ),
            const SizedBox(height: 12),
              ...
              children: [
                Expanded(
                  child: DropdownButtonFormField<String>(
                    ...
                    isExpanded: true,
                    decoration:
                        _dec("Asset Type", icon: Icons.category_rounded),
              ...
              children: [
                Expanded(
                  child: TextFormField(
                    ...
                    decoration: _dec("Quantity",
                        icon: Icons.numbers_rounded, hint: "eg. 10"),
                ...
                Expanded(
                  child: TextFormField(
                    ...
                    decoration: _dec("Avg Price / Unit",
                        icon: Icons.trending_up, hint: "Current Price"),
                    onChanged: (_) => setState(_maybeAutoCalcValue),
                  ),
                ),
              ],
            ...
            TextFormField(
              ...
              decoration:
                  _dec("Total Value (₹)", icon: Icons.currency_rupee_rounded),
              validator: (val) =>
              ...
              children: [
                Expanded(
                  child: TextFormField(
                    ...
                    decoration: _dec("Invested Amt (₹)",
                        icon: Icons.local_atm_rounded, hint: "Optional"),
                  ),
                ),
                const SizedBox(width: 12),
                Expanded(
                ...
                Expanded(
                  child: TextFormField(
                    ...
                    decoration: _dec("Currency",
                        icon: Icons.public_rounded, hint: "INR / USD…"),
                  ),
                ),
                const SizedBox(width: 12),
                Expanded(
                  child: TextFormField(
                    ...
                    decoration: _dec("Logo Hint",
                        icon: Icons.image_rounded, hint: "eg. HDFC, Zerodha"),
                  ),
                ),
              ],
            ),
            ...
            TextFormField(
              ...
              decoration: _dec("Tags",
                  icon: Icons.sell_rounded, hint: "Comma separated"),
            ),
            const SizedBox(height: 10),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text("Your portfolio has been updated.",
