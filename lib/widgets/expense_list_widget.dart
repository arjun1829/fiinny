...
class ExpenseListWidget extends StatelessWidget {
  ...
  double _pairSigned(ExpenseItem e, String you, String other) {
    ...
    if (_isSettlement(e)) {
      ...
      if (e.payerId == you && others.contains(other)) {
        return per; // you paid them
      }
      if (e.payerId == other && others.contains(you)) {
        return -per; // they paid you
      }
      return 0.0;
    }
  ...
  IconData _categoryIcon(String? cat) {
    ...
    if (c.contains('movie') || c.contains('entertain')) {
    ...
    return ListView.separated(
      ...
      itemBuilder: (context, i) {
        ...
        if (friend != null) {
          ...
          trailingText =
              "${paidByYou ? "- " : "+ "}${_money(e.amount, noPaise: true)}";
          trailingColor =
              paidByYou ? Colors.red.shade700 : Colors.green.shade700;
        }
        ...
        if (isSettlement) {
          ...
          final settleText =
              paidByYou ? "You settled with $who" : "$who settled with you";
          chips.add(_chip(
            text: settleText,
          ...
          chips.add(_chip(
            text: paidByYou
                ? "You paid"
                : "Paid by ${friend != null ? friend!.name : 'member'}",
        ...
        return InkWell(
          ...
          onTap: () => onTapExpense != null
              ? onTapExpense!(e)
              : _showFallbackDetails(context, e),
          onLongPress: () =>
              _showActions(context, e, canDelete: onDelete != null),
          child: Container(
                  ...
                  Flexible(
                    child: Text(
                      (e.attachmentName ?? '').trim().isNotEmpty
                          ...
                          : ((e.attachmentUrl ?? '').trim().isNotEmpty
                              ? 'Attachment'
                              : 'Link in note'),
                      overflow: TextOverflow.ellipsis,
                    ),
  ...
  void _showActions(BuildContext context, ExpenseItem e,
