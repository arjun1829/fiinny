    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            icon:
            Icon(Icons.history_rounded, color: Color(0xFF09857a), size: 24),
            tooltip: 'Activity',
            onPressed: () => Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (ctx) =>
                      DashboardActivityScreen(events: dashboardEvents)),
            ),
          ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          // NEW ▶︎ Fiinnny Brain Diagnosis (minimisable + Run button + live counter)
                          FiinnyBrainDiagnosisCard(
                            userPhone: widget.userPhone,
                            daysWindow: 90,            // scan window (tweak: 30/60/180)
                            initiallyExpanded: true,   // set false if you want it collapsed by default
                          ),
