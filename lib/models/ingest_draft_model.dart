...
class IngestDraft {
  ...
  final Map<String, dynamic>? fxOriginal;  // {currency:'USD', amount: 23.6} if detected
  ...
  static IngestDraft fromFirestore(Map<String, dynamic> data, String id) {
    ...
    return IngestDraft(
      ...
      brain: (data['brain'] is Map) ? Map<String, dynamic>.from(data['brain'] as Map) : null,
      fxOriginal: (data['fxOriginal'] is Map)
          ? Map<String, dynamic>.from(data['fxOriginal'] as Map)
          : null,
      sources: (data['sources'] is Iterable) ? List<dynamic>.from(data['sources']) : const [],
