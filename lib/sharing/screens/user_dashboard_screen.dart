...
class _UserDashboardScreenState extends State<UserDashboardScreen>
  ...
  void _onRingTap(int ringIndex) async {
    if (ringIndex < 0 || ringIndex >= last7Days.length) {
      return;
    }
                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          child: Stack(
                            ...
                            children: [
                              CircularProgressIndicator(
                                value: ((selCredit + selDebit) / 1000.0)
                                    .clamp(0.0, 1.0),
                                strokeWidth: 13,
                                backgroundColor: Colors.grey[300],
                                valueColor: AlwaysStoppedAnimation<Color>(
                                  ((selCredit + selDebit) / 1000.0) >= 1.0
                                      ? Colors.green
                                      : Colors.teal,
                                ),
                              ),
                        ...
                        Text(
                          ...
                          style:
                              TextStyle(fontSize: 14, color: Colors.teal[900]),
                        ),
                      ],
                    ),
                  ),
