...
class GroupRemoveMembersSheet extends StatefulWidget {
  ...
  @override
  State<GroupRemoveMembersSheet> createState() =>
      _GroupRemoveMembersSheetState();
}
...
class _GroupRemoveMembersSheetState extends State<GroupRemoveMembersSheet> {
  ...
  bool _canRemove(String phone) {
    if (phone == widget.group.createdBy) {
      return false; // don't remove creator
    }
    if (phone == widget.currentUserPhone) {
      return false; // don't remove yourself here
    }
    return true;
  }
  ...
  Widget build(BuildContext context) {
    final candidates =
        widget.members.where((m) => _canRemove(m.phone)).toList();
                      ...
                      : ListView.separated(
                          ...
                          itemBuilder: (_, i) {
                            ...
                            return CheckboxListTile(
                              ...
                              subtitle:
                                  f.phone.isNotEmpty ? Text(f.phone) : null,
